...
/*
  TODO зачем нужна история с creationParams на страте - не понятно.
  ...
  upd: почему-то эта итория настойчиво продолжает сканить с выключенной вьюхой, пришлось делать pauseScanner.
